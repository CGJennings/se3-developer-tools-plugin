...
/**
 * Task type for creating catalog tasks. Used to create private plug-in
 * catalogs or test how plug-ins will appear in a catalog.
 * 
...
final class CatToolsTaskType extends NewTaskType {
	...
	public String getDescription() {
		return
"Create a local plug-in catalogue to test how your plug-in will appear in " +
